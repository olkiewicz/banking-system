...
from .views import (
    AccountApiView, AddressApiView, ClientsListApiView, AccountTypeApiView, CurrencyApiView, TransferApiView,
)
...
urlpatterns = [
    ...
    re_path(r'^transfers/(?P<transfer_id>[0-9]*)', TransferApiView.as_view())
]
